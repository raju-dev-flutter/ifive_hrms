...
class _LeaveScreenState extends State<LeaveScreen> {
          ...
          child: CustomAppBar(
            ...
            actions: [
              IconButton(
                ...
                icon: Icon(Icons.add, color: appColor.gray950),
              ),
            ],
            bottom: TabBar(
  ...
  Widget _buildBodyUI() {
    return TabBarView(
      ...
      children: [_leaveApprovedUI(), _leaveHistoryUI()],
    );
  }

  Widget _leaveHistoryUI() {
      ...
      builder: (context, state) {
        ...
        if (state is LeaveHistoryLoaded) {
          if (state.history.leavehistory!.isEmpty) {
            return Lottie.asset(AppLottie.empty);
          }
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        SizedBox(
                          width: 10.w,
                          child: Divider(color: appColor.brand600),
                        ),
                        Dimensions.kHorizontalSpaceSmall,
                        Text(leave.startDate ?? '',
                            style: context.textTheme.labelMedium
