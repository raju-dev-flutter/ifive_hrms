...
class ProjectTaskUpdateScreen extends StatefulWidget {
  const ProjectTaskUpdateScreen({super.key});

  @override
  State<ProjectTaskUpdateScreen> createState() =>
      _ProjectTaskUpdateScreenState();
}

class _ProjectTaskUpdateScreenState extends State<ProjectTaskUpdateScreen> {
                    ...
                    itemBuilder: (_, i) {
                      ...
                      return ProjectTaskDetailCardWidget(
                        onPressed: () {
                          Navigator.pushNamed(
                            context,
                            AppRouterPath.projectTaskUpdateFormScreen,
                            arguments: ProjectTaskUpdateFormScreen(
                                task: state.task[i]),
