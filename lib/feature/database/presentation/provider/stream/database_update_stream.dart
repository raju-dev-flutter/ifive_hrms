...
class DatabaseUpdateStream {
  ...
  final _pageLoading = BehaviorSubject<bool>.seeded(false);
  ...
  ValueStream<bool> get pageLoading => _pageLoading;
  ...
  void fetchInitialCallBack(DatabaseData database) async {
    ...
    Logger().i("Industry : ${database.companyIndustry}");
    ...
    Logger().i(database.companyVertical);
  ...
  void onSubmit(BuildContext context, DatabaseData database) {
    ...
    BlocProvider.of<SfaCrudBloc>(context)
        .add(GenerateTicketEvent(body: body, type: "database"));
  }
