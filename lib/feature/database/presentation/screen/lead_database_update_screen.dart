...
class _LeadDatabaseUpdateScreenState extends State<LeadDatabaseUpdateScreen>
  ...
  List<Widget> _buildFieldActivityDetailUI() {
    return [
      CustomTextFormField(
        label: "Name",
        controller: leadDatabase.fNameController,
        required: false,
      ),
      Dimensions.kVerticalSpaceSmaller,
      CustomTextFormField(
        label: "Mobile Number",
        controller: leadDatabase.fNumberController,
        required: false,
      ),
      Dimensions.kVerticalSpaceSmaller,
      CustomTextFormField(
        label: "Design & Dept",
        controller: leadDatabase.fDesignDeptController,
        required: false,
      ),
      Dimensions.kVerticalSpaceSmaller,
      CustomTextFormField(
        label: "E-Mail Id",
        controller: leadDatabase.fEmailController,
        required: false,
      ),
      Dimensions.kVerticalSpaceSmaller,
      CustomTextFormField(
        label: "Whatsapp Number",
        controller: leadDatabase.fWhatsappNumberController,
        required: false,
      ),
      Dimensions.kVerticalSpaceSmaller,
      CustomTextFormField(
        label: "Remarks",
        maxLines: 4,
        controller: leadDatabase.fRemarksController,
        required: false,
      ),
    ];
  }
